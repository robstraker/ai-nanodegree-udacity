...
class PlanningGraph():
    ...
    def __init__(self, problem: Problem, state: str, serial_planning=True):
        ...
        Instance variable calculated:
            ...
            all_fions: list of the PlanningProblem valid ground actions combined with calculated no-op actions
    ...
    def add_action_level(self, level):
		...
		# New action level is made up of all reachable action nodes, in which preconditions are satisfied
    ...
    def add_literal_level(self, level):
        ...
        # Identify effect nodes from previous actions, and if reachable, add to new state level.
    ...
    def inconsistent_effects_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        # For a pair of actions, compare whether negative effects of one are inconsistent 
        # with positive effects of the other, and vice versa. 
    ...
    def interference_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        # For a pair of actions, compare whether negative effects of one are in conflict
        # with the positive preconditions of the other, and vice versa.
    ...
    def competing_needs_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        # For a pair of actions, compare whether there is a conflict between preconditions.
    ...
    def negation_mutex(self, node_s1: PgNode_s, node_s2: PgNode_s) -> bool:
        ...
        # For a pair of state literals, compare whether they are equal but opposite in sign.
    ...
    def inconsistent_support_mutex(self, node_s1: PgNode_s, node_s2: PgNode_s):
        ...
        # For a pair of state literals, compare whether their preconditions are in conflict.
        
        for precond_s1 in node_s1.parents:
            for precond_s2 in node_s2.parents:
                if precond_s1.is_mutex(precond_s2) == False:
                    return False
    ...
    def h_levelsum(self) -> int:
        ...
        level_sum = 0
        # TODO implement
        # Add the costs for each goal, as represented by the level in which that goal appears.
